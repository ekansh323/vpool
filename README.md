...
- Allows others to search and filter rides by route and date<br>
- Riders can request to join a ride<br>
- Ride owners can approve or reject requests<br>
- Seats update automatically<br>
...
## About the Project
ViPool was built as a real‑world learning project based on personal experience, not just as a college assignment. The focus was on solving a practical problem with clean UI, simple logic, and secure backend rules.